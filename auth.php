<?php include_once('settings_config.php'); require('function_js.php');?>
<?php if($session_username){ header('location: index.php'); } ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane px-3 pt-3" id="Register_Tab" role="tabpanel">
                                            <form class="form-horizontal auth-form" id="Register">
                                            <p id="msg2"></p>
                                            <br>                   
                                                <div class="form-group mb-2">
                                                    <label class="form-label" for="username">Username</label>
